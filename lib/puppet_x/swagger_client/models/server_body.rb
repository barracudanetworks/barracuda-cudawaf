...
module SwaggerClient
  class ServerBody
    ...
    def initialize(attributes = {})
      ...
      self.identifier = if attributes.key?(:identifier)
    ...
    def identifier=(identifier)
      ...
      unless validator.valid?(identifier)
        raise ArgumentError, "invalid value for 'identifier', must be one of #{validator.allowable_values}."
      end
      @identifier = identifier
    end
    ...
    def address_version=(address_version)
      validator = EnumAttributeValidator.new('String', %w[IPv4 IPv6])
      unless validator.valid?(address_version)
        raise ArgumentError, "invalid value for 'address_version', must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [identifier, address_version, status, name, ip_address, hostname, port, comments].hash
    end
