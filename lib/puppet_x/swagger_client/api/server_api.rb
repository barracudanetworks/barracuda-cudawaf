  ...
  class ServerApi
    ...
    def services_web_application_name_servers_get_with_http_info(authorization, web_application_name, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.nil?
        raise ArgumentError, "Missing the required parameter 'authorization' when calling ServerApi.services_web_application_name_servers_get"
      end
      ...
      if @api_client.config.client_side_validation && web_application_name.nil?
        raise ArgumentError, "Missing the required parameter 'web_application_name' when calling ServerApi.services_web_application_name_servers_get"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def services_web_application_name_servers_post_with_http_info(authorization, web_application_name, server, _opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServerApi.services_web_application_name_servers_post ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        raise ArgumentError, "Missing the required parameter 'authorization' when calling ServerApi.services_web_application_name_servers_post"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        raise ArgumentError, "Missing the required parameter 'web_application_name' when calling ServerApi.services_web_application_name_servers_post"
      end
      # verify the required parameter 'server' is set
      if @api_client.config.client_side_validation && server.nil?
        raise ArgumentError, "Missing the required parameter 'server' when calling ServerApi.services_web_application_name_servers_post"
      end
      # resource path
      local_var_path = '/services/{Web Application Name}/servers'.sub('{' + 'Web Application Name' + '}', web_application_name.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def services_web_application_name_servers_server_name_delete_with_http_info(authorization, web_application_name, server_name, _opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServerApi.services_web_application_name_servers_server_name_delete ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        raise ArgumentError, "Missing the required parameter 'authorization' when calling ServerApi.services_web_application_name_servers_server_name_delete"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        raise ArgumentError, "Missing the required parameter 'web_application_name' when calling ServerApi.services_web_application_name_servers_server_name_delete"
      end
      # verify the required parameter 'server_name' is set
      if @api_client.config.client_side_validation && server_name.nil?
        raise ArgumentError, "Missing the required parameter 'server_name' when calling ServerApi.services_web_application_name_servers_server_name_delete"
      end
      # resource path
    ...
    def services_web_application_name_servers_server_name_get_with_http_info(authorization, web_application_name, server_name, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        raise ArgumentError, "Missing the required parameter 'authorization' when calling ServerApi.services_web_application_name_servers_server_name_get"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        raise ArgumentError, "Missing the required parameter 'web_application_name' when calling ServerApi.services_web_application_name_servers_server_name_get"
      end
      # verify the required parameter 'server_name' is set
      if @api_client.config.client_side_validation && server_name.nil?
        raise ArgumentError, "Missing the required parameter 'server_name' when calling ServerApi.services_web_application_name_servers_server_name_get"
      end
      # resource path
      local_var_path = '/services/{Web Application Name}/servers/{Server Name}  '.sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Server Name' + '}', server_name.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def services_web_application_name_servers_server_name_put_with_http_info(authorization, web_application_name, server_name, server, _opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServerApi.services_web_application_name_servers_server_name_put ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        raise ArgumentError, "Missing the required parameter 'authorization' when calling ServerApi.services_web_application_name_servers_server_name_put"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        raise ArgumentError, "Missing the required parameter 'web_application_name' when calling ServerApi.services_web_application_name_servers_server_name_put"
      end
      # verify the required parameter 'server_name' is set
      if @api_client.config.client_side_validation && server_name.nil?
        raise ArgumentError, "Missing the required parameter 'server_name' when calling ServerApi.services_web_application_name_servers_server_name_put"
      end
      # verify the required parameter 'server' is set
      if @api_client.config.client_side_validation && server.nil?
        raise ArgumentError, "Missing the required parameter 'server' when calling ServerApi.services_web_application_name_servers_server_name_put"
      end
      # resource path
      local_var_path = '/services/{Web Application Name}/servers/{Server Name} '.sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Server Name' + '}', server_name.to_s)
