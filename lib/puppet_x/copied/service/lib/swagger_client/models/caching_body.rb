...
module SwaggerClient
  ...
  class CachingBody
    ...
    attr_accessor :cache_negative_response
    ...
    def self.attribute_map
      {
        :'cache_negative_response' => :'cache-negative-response',
        :'status' => :'status',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cache-negative-response')
        self.cache_negative_response = attributes[:'cache-negative-response']
      else
        self.cache_negative_response = "No"
      end
    ...
    def valid?
      cache_negative_response_validator = EnumAttributeValidator.new('String', ["Yes", "No"])
      return false unless cache_negative_response_validator.valid?(@cache_negative_response)
    ...
    # @param [Object] cache_negative_response Object to be assigned
    def cache_negative_response=(cache_negative_response)
      validator = EnumAttributeValidator.new('String', ["Yes", "No"])
      unless validator.valid?(cache_negative_response)
        fail ArgumentError, "invalid value for 'cache_negative_response', must be one of #{validator.allowable_values}."
      end
      @cache_negative_response = cache_negative_response
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cache_negative_response == o.cache_negative_response &&
          status == o.status &&
    ...
    def hash
      [cache_negative_response, status, file_extensions, expiry_age, ignore_response_headers, min_size, ignore_request_headers, max_size].hash
    end
