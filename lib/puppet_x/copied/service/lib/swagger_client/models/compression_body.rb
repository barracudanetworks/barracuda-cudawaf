...
module SwaggerClient
  ...
  class CompressionBody
    ...
    # Compress Unknown Content Types
    attr_accessor :unknown_content_types
    ...
    def self.attribute_map
      {
        ...
        :'status' => :'status',
        :'min_size' => :'min-size',
        :'unknown_content_types' => :'unknown-content-types'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'unknown-content-types')
        self.unknown_content_types = attributes[:'unknown-content-types']
      else
        self.unknown_content_types = "No"
      end
    ...
    def valid?
      ...
      unknown_content_types_validator = EnumAttributeValidator.new('String', ["Yes", "No"])
      return false unless unknown_content_types_validator.valid?(@unknown_content_types)
      return true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] unknown_content_types Object to be assigned
    def unknown_content_types=(unknown_content_types)
      validator = EnumAttributeValidator.new('String', ["Yes", "No"])
      unless validator.valid?(unknown_content_types)
        fail ArgumentError, "invalid value for 'unknown_content_types', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          min_size == o.min_size &&
          unknown_content_types == o.unknown_content_types
    end
    ...
    def hash
      [content_types, status, min_size, unknown_content_types].hash
    end
