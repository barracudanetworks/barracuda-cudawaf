...
module SwaggerClient
  ...
  class SslOcspBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'responder-url')
        self.responder_url = attributes[:'responder-url']
      end
    ...
    def hash
      [enable, responder_url, certificate].hash
    end
