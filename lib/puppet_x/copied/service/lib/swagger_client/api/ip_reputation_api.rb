...
module SwaggerClient
  class IpReputationApi
    ...
    def services_web_application_name_ip_reputation_get(authorization, web_application_name, opts = {})
      services_web_application_name_ip_reputation_get_with_http_info(authorization, web_application_name, opts)
      return nil
    end
    ...
    def services_web_application_name_ip_reputation_put(authorization, web_application_name, ip_reputation, opts = {})
      services_web_application_name_ip_reputation_put_with_http_info(authorization, web_application_name, ip_reputation, opts)
      return nil
    end
