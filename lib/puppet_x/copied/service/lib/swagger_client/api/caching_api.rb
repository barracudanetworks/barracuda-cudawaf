...
module SwaggerClient
  class CachingApi
    ...
    def services_web_application_name_caching_get(authorization, web_application_name, opts = {})
      services_web_application_name_caching_get_with_http_info(authorization, web_application_name, opts)
      return nil
    end
    ...
    def services_web_application_name_caching_put(authorization, web_application_name, caching, opts = {})
      services_web_application_name_caching_put_with_http_info(authorization, web_application_name, caching, opts)
      return nil
    end
