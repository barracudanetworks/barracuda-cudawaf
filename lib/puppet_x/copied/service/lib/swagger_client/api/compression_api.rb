...
module SwaggerClient
  class CompressionApi
    ...
    def services_web_application_name_compression_get(authorization, web_application_name, opts = {})
      services_web_application_name_compression_get_with_http_info(authorization, web_application_name, opts)
      return nil
    end
    ...
    def services_web_application_name_compression_put(authorization, web_application_name, compression, opts = {})
      services_web_application_name_compression_put_with_http_info(authorization, web_application_name, compression, opts)
      return nil
    end
