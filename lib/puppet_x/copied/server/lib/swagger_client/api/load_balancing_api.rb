...
module SwaggerClient
  class LoadBalancingApi
    ...
    def services_web_application_name_servers_web_server_name_load_balancing_get(authorization, web_application_name, web_server_name, opts = {})
      services_web_application_name_servers_web_server_name_load_balancing_get_with_http_info(authorization, web_application_name, web_server_name, opts)
      return nil
    end
    ...
    def services_web_application_name_servers_web_server_name_load_balancing_put(authorization, web_application_name, web_server_name, load_balancing, opts = {})
      services_web_application_name_servers_web_server_name_load_balancing_put_with_http_info(authorization, web_application_name, web_server_name, load_balancing, opts)
      return nil
    end
