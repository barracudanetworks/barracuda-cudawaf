...
module SwaggerClient
  class SecurityPolicyApi
    ...
    def security_policies_get(authorization, opts = {})
      security_policies_get_with_http_info(authorization, opts)
      return nil
    end
    ...
    def security_policies_policy_name_delete(authorization, policy_name, opts = {})
      security_policies_policy_name_delete_with_http_info(authorization, policy_name, opts)
      return nil
    end
    ...
    def security_policies_policy_name_get(authorization, policy_name, opts = {})
      security_policies_policy_name_get_with_http_info(authorization, policy_name, opts)
      return nil
    end
    ...
    def security_policies_policy_name_put(authorization, policy_name, security_policy, opts = {})
      security_policies_policy_name_put_with_http_info(authorization, policy_name, security_policy, opts)
      return nil
    end
    ...
    def security_policies_post(authorization, security_policy, opts = {})
      security_policies_post_with_http_info(authorization, security_policy, opts)
      return nil
    end
