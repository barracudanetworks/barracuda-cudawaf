  ...
  class ContentRuleServerApi
    ...
    def content_rule_servers_get_with_http_info(authorization, web_application_name, rule_group_name, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleServerApi.content_rule_servers_get"
      end
      ...
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleServerApi.content_rule_servers_get"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleServerApi.content_rule_servers_get"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def content_rule_servers_post_with_http_info(authorization, web_application_name, rule_group_name, rule_group_server, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContentRuleServerApi.content_rule_servers_post ..."
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleServerApi.content_rule_servers_post"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleServerApi.content_rule_servers_post"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleServerApi.content_rule_servers_post"
      end
      # verify the required parameter 'rule_group_server' is set
      if @api_client.config.client_side_validation && rule_group_server.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_server' when calling ContentRuleServerApi.content_rule_servers_post"
      end
      # resource path
      local_var_path = "/services/{Web Application Name}/content-rules/{Rule Group Name}/content-rule-servers".sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Rule Group Name' + '}', rule_group_name.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def content_rule_servers_web_server_name_delete_with_http_info(authorization, web_application_name, rule_group_name, web_server_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContentRuleServerApi.content_rule_servers_web_server_name_delete ..."
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleServerApi.content_rule_servers_web_server_name_delete"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_delete"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_delete"
      end
      # verify the required parameter 'web_server_name' is set
      if @api_client.config.client_side_validation && web_server_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_server_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_delete"
      end
      # resource path
    ...
    def content_rule_servers_web_server_name_get_with_http_info(authorization, web_application_name, rule_group_name, web_server_name, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleServerApi.content_rule_servers_web_server_name_get"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_get"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_get"
      end
      # verify the required parameter 'web_server_name' is set
      if @api_client.config.client_side_validation && web_server_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_server_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_get"
      end
      # resource path
      local_var_path = "/services/{Web Application Name}/content-rules/{Rule Group Name}/content-rule-servers/{Web Server Name}".sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Rule Group Name' + '}', rule_group_name.to_s).sub('{' + 'Web Server Name' + '}', web_server_name.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def content_rule_servers_web_server_name_put_with_http_info(authorization, web_application_name, rule_group_name, web_server_name, rule_group_server, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContentRuleServerApi.content_rule_servers_web_server_name_put ..."
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleServerApi.content_rule_servers_web_server_name_put"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_put"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_put"
      end
      # verify the required parameter 'web_server_name' is set
      if @api_client.config.client_side_validation && web_server_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_server_name' when calling ContentRuleServerApi.content_rule_servers_web_server_name_put"
      end
      # verify the required parameter 'rule_group_server' is set
      if @api_client.config.client_side_validation && rule_group_server.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_server' when calling ContentRuleServerApi.content_rule_servers_web_server_name_put"
      end
      # resource path
      local_var_path = "/services/{Web Application Name}/content-rules/{Rule Group Name}/content-rule-servers/{Web Server Name}".sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Rule Group Name' + '}', rule_group_name.to_s).sub('{' + 'Web Server Name' + '}', web_server_name.to_s)
