...
module SwaggerClient
  class InBandHealthChecksApi
    ...
    def services_web_application_name_servers_web_server_name_in_band_health_checks_get(authorization, web_application_name, web_server_name, opts = {})
      services_web_application_name_servers_web_server_name_in_band_health_checks_get_with_http_info(authorization, web_application_name, web_server_name, opts)
      return nil
    end
    ...
    def services_web_application_name_servers_web_server_name_in_band_health_checks_put(authorization, web_application_name, web_server_name, in_band_health_checks, opts = {})
      services_web_application_name_servers_web_server_name_in_band_health_checks_put_with_http_info(authorization, web_application_name, web_server_name, in_band_health_checks, opts)
      return nil
    end
