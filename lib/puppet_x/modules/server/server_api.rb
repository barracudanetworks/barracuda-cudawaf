...
module SwaggerClient
  class ServerApi
    ...
    def services_web_application_name_servers_post(authorization, web_application_name, server, opts = {})
      data, status_code, headers = services_web_application_name_servers_post_with_http_info(authorization, web_application_name, server, opts)
      return data, status_code, headers
    end
    ...
    def services_web_application_name_servers_server_name_delete(authorization, web_application_name, server_name, opts = {})
      data, status_code, headers= services_web_application_name_servers_server_name_delete_with_http_info(authorization, web_application_name, server_name, opts)
      return data, status_code, headers
    end
