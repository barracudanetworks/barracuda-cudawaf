  ...
  class ContentRuleApi
    ...
    def content_rules_get_with_http_info(authorization, web_application_name, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleApi.content_rules_get"
      end
      ...
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleApi.content_rules_get"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def content_rules_post_with_http_info(authorization, web_application_name, rule_group, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContentRuleApi.content_rules_post ..."
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleApi.content_rules_post"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleApi.content_rules_post"
      end
      # verify the required parameter 'rule_group' is set
      if @api_client.config.client_side_validation && rule_group.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group' when calling ContentRuleApi.content_rules_post"
      end
      # resource path
      local_var_path = "/services/{Web Application Name}/content-rules".sub('{' + 'Web Application Name' + '}', web_application_name.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def content_rules_rule_group_name_delete_with_http_info(authorization, web_application_name, rule_group_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContentRuleApi.content_rules_rule_group_name_delete ..."
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleApi.content_rules_rule_group_name_delete"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleApi.content_rules_rule_group_name_delete"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleApi.content_rules_rule_group_name_delete"
      end
      # resource path
    ...
    def content_rules_rule_group_name_get_with_http_info(authorization, web_application_name, rule_group_name, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleApi.content_rules_rule_group_name_get"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleApi.content_rules_rule_group_name_get"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleApi.content_rules_rule_group_name_get"
      end
      # resource path
      local_var_path = "/services/{Web Application Name}/content-rules/{Rule Group Name}".sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Rule Group Name' + '}', rule_group_name.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def content_rules_rule_group_name_put_with_http_info(authorization, web_application_name, rule_group_name, rule_group, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContentRuleApi.content_rules_rule_group_name_put ..."
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling ContentRuleApi.content_rules_rule_group_name_put"
      end
      # verify the required parameter 'web_application_name' is set
      if @api_client.config.client_side_validation && web_application_name.nil?
        fail ArgumentError, "Missing the required parameter 'web_application_name' when calling ContentRuleApi.content_rules_rule_group_name_put"
      end
      # verify the required parameter 'rule_group_name' is set
      if @api_client.config.client_side_validation && rule_group_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group_name' when calling ContentRuleApi.content_rules_rule_group_name_put"
      end
      # verify the required parameter 'rule_group' is set
      if @api_client.config.client_side_validation && rule_group.nil?
        fail ArgumentError, "Missing the required parameter 'rule_group' when calling ContentRuleApi.content_rules_rule_group_name_put"
      end
      # resource path
      local_var_path = "/services/{Web Application Name}/content-rules/{Rule Group Name}".sub('{' + 'Web Application Name' + '}', web_application_name.to_s).sub('{' + 'Rule Group Name' + '}', rule_group_name.to_s)
