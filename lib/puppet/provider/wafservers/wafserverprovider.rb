...
def exists?
  Puppet.info("Calling exists method of wafsererprovider: ")
...
# call get service
  ...
  options={}
  serviceresponse = service_instance.services_web_application_name_get(auth_header,serviceName,options)
