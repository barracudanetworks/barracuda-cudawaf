...
require_relative '../../../puppet_x/modules/rule_group/rule_group_compression_api.rb'
...
require 'uri'
require 'logger'
Puppet::Type.type(:rule_group_compression).provide(:rule_group_compressionprovider) do
...
def exists?
  ...
  rule_group_compression_instance = SwaggerClient::RuleGroupCompressionApi.new
# call get service
...
# Checking if the service exists in the WAF system.
  ...
  if service_status_code === '200'
   # call get server
    data,status_code,headers= rule_group_compression_instance.services_web_application_name_content_rules_rule_group_name_compression_get(auth_header,serviceName,ruleName)
...
def flush
  ...
  if @property_hash != {}
     ...
     data,status_code,headers = rule_group_compression_instance.services_web_application_name_content_rules_rule_group_name_compression_put(auth_header,serviceName,ruleName,message(resource),{})
