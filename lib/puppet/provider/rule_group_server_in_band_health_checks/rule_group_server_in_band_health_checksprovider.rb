...
require_relative '../../../puppet_x/modules/rule_group_server/rule_group_server_in_band_health_checks_api.rb'
...
Puppet::Type.type(:rule_group_server_in_band_health_checks).provide(:rule_group_server_in_band_health_checksprovider) do
  Puppet.debug("Inside rule_group_server_in_band_health_checksprovider: ")
  mk_resource_methods
  ...
  def self.getservices
     Puppet.debug("Calling getservices  method of rule_group_server_in_band_health_checksprovider: ")
     service_instances = []
     login_instance = Login.new
     auth_header = login_instance.get_auth_header
  ...
  def flush
    ...
    rule_grp_server_Name = @resource[:name]
      data,status_code,headers = rule_group_server_instance.services_web_application_name_content_rules_rule_group_name_content_rule_servers_web_server_name_in_band_health_checks_put(auth_header,serviceName,rule_group_name,rule_grp_server_Name,message(resource),{})
  ...
  def create
    Puppet.debug("Calling create method of rule_group_server_in_band_health_checksprovider: ")
  end

  def destroy
    Puppet.debug("Calling destroy method of rule_group_server_in_band_health_checksprovider: ")
  end
end
