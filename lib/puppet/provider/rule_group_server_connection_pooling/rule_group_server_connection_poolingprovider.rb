...
require_relative '../../../puppet_x/modules/rule_group_server/rule_group_server_connection_pooling_api.rb'
...
Puppet::Type.type(:rule_group_server_connection_pooling).provide(:rule_group_server_connection_poolingprovider) do
  Puppet.debug("Inside rule_group_server_connection_poolingprovider: ")
  mk_resource_methods

  def exists?
    Puppet.debug("Calling exists method of rule_group_server_connection_poolingprovider: ")
    @property_hash[:ensure] == :present
    login_instance = Login.new
    auth_header = login_instance.get_auth_header
    service_instance = SwaggerClient::ServiceApi.new
    rule_group_instance = SwaggerClient::RuleGroupApi.new
    rule_group_server_instance = SwaggerClient::RuleGroupServerConnectionPoolingApi.new
    #call get service
    ...
    # check if the rule group exists'
      ...
      Puppet.debug("status_code received from WAF api GET rule group:  #{status_code}")
         if status_code === 200
           data,status_code,headers = rule_group_server_instance.services_web_application_name_content_rules_rule_group_name_content_rule_servers_web_server_name_connection_pooling_get(auth_header,serviceName,rule_group_name,rule_grp_server_Name)
             if status_code === 200
                true
  ...
  def self.instances
    ...
    services.each do |service|
      ...
      rules.each do |rule|
        rule_name = rule
        Puppet.debug("Calling getInstances method of rule_group_server_connection_poolingprovider: ")
        ...
        # get all rule_group_server_connection_pooling from WAF
        ...
        Puppet.debug("WAF Get all rule_group_server_connection_pooling response:    #{data}")
  ...
  def self.getservices
     Puppet.debug("Calling getservices  method of rule_group_server_connection_poolingprovider: ")
     service_instances = []
     login_instance = Login.new
     auth_header = login_instance.get_auth_header
     service_instance = SwaggerClient::ServiceApi.new
  ...
  def self.getrules(service_name)
     Puppet.debug("Calling getrules  method of rule_group_server_connection_poolingprovider: ")
  ...
  def self.prefetch(resources)
    Puppet.debug("Calling prefetch method of rule_group_server_connection_poolingprovider: ")
    rules = instances
  ...
  def flush
    Puppet.debug("Calling flush method of rule_group_server_connection_poolingprovider: ")
    if @property_hash != {}
      login_instance = Login.new
      auth_header = login_instance.get_auth_header
      rule_group_server_instance = SwaggerClient::RuleGroupServerConnectionPoolingApi.new
    ...
    rule_group_name = @resource[:rule_group_name]
    rule_grp_server_Name = @resource[:name]
      data,status_code,headers = rule_group_server_instance.services_web_application_name_content_rules_rule_group_name_content_rule_servers_web_server_name_connection_pooling_put(auth_header,serviceName,rule_group_name,rule_grp_server_Name,message(resource),{})
  ...
  def create
    Puppet.debug("Calling create method of rule_group_server_connection_poolingprovider: ")
  end

  def destroy
    Puppet.debug("Calling destroy method of rule_group_server_connection_poolingprovider: ")
  end
end
