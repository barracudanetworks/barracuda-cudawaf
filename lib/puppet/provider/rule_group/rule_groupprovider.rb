...
# Checking if the service exists in the WAF system.
  ...
  if service_status_code === '200'
   # call get server
    data,status_code,headers= rule_instance.services_web_application_name_content_rules_rule_group_name_get(auth_header,serviceName,ruleName)
...
def flush
  ...
  if @property_hash != {}
     ...
     data,status_code,headers = rule_instance.services_web_application_name_content_rules_rule_group_name_put(auth_header,serviceName,ruleName,message(resource),{})
...
def create
  ...
  rule_instance = SwaggerClient::RuleGroupApi.new
  # getting token end
  result = rule_instance.services_web_application_name_content_rules_post(auth_header,serviceName, message(resource),{})
