...
def exists?
  ...
  Puppet.debug("The cerName from manifest  #{cerName}")
  ...
  response = RestClient.get "http://10.36.73.244:8000/restapi/v3/certificates/#{cerName}", {:Authorization => "#{auth_header}", accept: :json, content_type: :json} 
