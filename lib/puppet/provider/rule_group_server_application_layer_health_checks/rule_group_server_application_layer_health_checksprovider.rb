...
require_relative '../../../puppet_x/modules/rule_group_server/rule_group_server_application_layer_health_checks_api.rb'
...
Puppet::Type.type(:rule_group_server_application_layer_health_checks).provide(:rule_group_server_application_layer_health_checksprovider) do
  Puppet.debug("Inside rule_group_server_application_layer_health_checksprovider: ")
  mk_resource_methods

  def exists?
    Puppet.debug("Calling exists method of rule_group_server_application_layer_health_checksprovider: ")
    @property_hash[:ensure] == :present
    login_instance = Login.new
    auth_header = login_instance.get_auth_header
    service_instance = SwaggerClient::ServiceApi.new
    rule_group_instance = SwaggerClient::RuleGroupApi.new
    rule_group_server_instance = SwaggerClient::RuleGroupServerApplicationLayerHealthChecksApi.new
    #call get service
    ...
    # check if the rule group exists'
      ...
      Puppet.debug("status_code received from WAF api GET rule group:  #{status_code}")
         if status_code === 200
           data,status_code,headers=rule_group_server_instance.services_web_application_name_content_rules_rule_group_name_content_rule_servers_web_server_name_application_layer_health_checks_get(auth_header,serviceName,rule_group_name,rule_grp_server_Name)
             if status_code === 200
                true
  ...
  def self.instances
    ...
    services.each do |service|
      ...
      rules.each do |rule|
        rule_name = rule
        Puppet.debug("Calling getInstances method of rule_group_server_application_layer_health_checksprovider: ")
        ...
        # get all rule_group_server_application_layer_health_checks from WAF
        ...
        Puppet.debug("WAF Get all rule_group_server_application_layer_health_checks response:    #{data}")
  ...
  def self.getservices
     Puppet.debug("Calling getservices  method of rule_group_server_application_layer_health_checksprovider: ")
     service_instances = []
     login_instance = Login.new
     auth_header = login_instance.get_auth_header
     service_instance = SwaggerClient::ServiceApi.new
  ...
  def self.getrules(service_name)
     Puppet.debug("Calling getrules  method of rule_group_server_application_layer_health_checksprovider: ")
  ...
  def self.prefetch(resources)
    Puppet.debug("Calling prefetch method of rule_group_server_application_layer_health_checksprovider: ")
    rules = instances
  ...
  def flush
    Puppet.debug("Calling flush method of rule_group_server_application_layer_health_checksprovider: ")
    if @property_hash != {}
      login_instance = Login.new
      auth_header = login_instance.get_auth_header
      rule_group_server_instance = SwaggerClient::RuleGroupServerApplicationLayerHealthChecksApi.new
    ...
    rule_group_name = @resource[:rule_group_name]
    rule_grp_server_Name = @resource[:name]
      data,status_code,headers = rule_group_server_instance.services_web_application_name_content_rules_rule_group_name_content_rule_servers_web_server_name_application_layer_health_checks_put(auth_header,serviceName,rule_group_name,rule_grp_server_Name,message(resource),{})
  ...
  def create
    Puppet.debug("Calling create method of rule_group_server_application_layer_health_checksprovider: ")
  end

  def destroy
    Puppet.debug("Calling destroy method of rule_group_server_application_layer_health_checksprovider: ")
  end
end
