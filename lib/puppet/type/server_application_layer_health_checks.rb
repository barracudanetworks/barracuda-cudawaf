Puppet::Type.newtype(:server_application_layer_health_checks) do
  @doc = 'Defines all possible types for Application Layer Health Checks of Server object on the Barracuda Web Application Firewall.'
