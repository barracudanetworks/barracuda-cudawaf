Puppet::Type.newtype(:server_ssl_policy) do
  @doc = 'Defines all possible types for Ssl Policy of Server object on the Barracuda Web Application Firewall.'
