Puppet::Type.newtype(:rule_group_load_balancing) do
  @doc = 'Defines all possible types for Load Balancing of Rule Group object on the Barracuda Web Application Firewall.'
