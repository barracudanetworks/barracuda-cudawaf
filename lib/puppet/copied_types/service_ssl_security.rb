Puppet::Type.newtype(:service_ssl_security) do
  @doc = 'Defines all possible types for Ssl Security of Service object on the Barracuda Web Application Firewall.'
  ...
  newproperty(:domain, :array_matching => :all) do
    desc "Domain"
  end
  ...
  newproperty(:sni_certificate, :array_matching => :all) do
    desc "Domain Certificate"
  end


  newproperty(:sni_ecdsa_certificate, :array_matching => :all) do
