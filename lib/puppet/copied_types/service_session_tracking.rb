Puppet::Type.newtype(:service_session_tracking) do
  @doc = 'Defines all possible types for Session Tracking of Service object on the Barracuda Web Application Firewall.'
  ...
  newproperty(:identifiers, :array_matching => :all) do
