Puppet::Type.newtype(:service_ftp_security) do
  @doc = 'Defines all possible types for Ftp Security of Service object on the Barracuda Web Application Firewall.'
  ...
  newproperty(:allowed_verbs, :array_matching => :all) do
  ...
  newproperty(:pasv_ports, :array_matching => :all) do
    desc "PASV Ports"
    validate do |value|
