Puppet::Type.newtype(:server_advanced_configuration) do
  @doc = 'Defines all possible types for Advanced Configuration of Server object on the Barracuda Web Application Firewall.'
