Puppet::Type.newtype(:attack_type_pattern) do
  @doc = 'Defines all possible types for Attack Type Pattern object on the Barracuda Web Application Firewall.'
