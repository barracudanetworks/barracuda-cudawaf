Puppet::Type.newtype(:service_advanced_configuration) do
  @doc = 'Defines all possible types for Advanced Configuration of Service object on the Barracuda Web Application Firewall.'
  ...
  newproperty(:accept_list, :array_matching => :all) do
    desc ""
  end
  ...
  newproperty(:ddos_exception_list, :array_matching => :all) do
  ...
  newproperty(:proxy_list, :array_matching => :all) do
    desc ""
  end
