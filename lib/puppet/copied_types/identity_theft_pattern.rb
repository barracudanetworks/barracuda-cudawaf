Puppet::Type.newtype(:identity_theft_pattern) do
  @doc = 'Defines all possible types for Identity Theft Pattern object on the Barracuda Web Application Firewall.'
