Puppet::Type.newtype(:system_wan_configuration) do
  @doc = 'Defines all possible types for Wan Configuration of System object on the Barracuda Web Application Firewall.'
